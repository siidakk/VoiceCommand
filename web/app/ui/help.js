...
const EXAMPLES = {
  en: {
    ...
    'help.search': ['Find toothpaste under 5 dollars', 'Find me organic apples', 'Show me Colgate toothpaste'],
    'help.manage': [
      "What's on my list",
      'What should I buy',
      'I got the eggs',
  ...
  hi: {
    ...
    'help.search': ['टूथपेस्ट 5 डॉलर से कम', 'शैम्पू 500 रुपये से कम'],
  ...
  es: {
    ...
    'help.search': ['Busca pasta de dientes menos de 5 euros', 'Busca manzanas'],
  ...
  fr: {
    ...
    'help.search': ['Trouve dentifrice moins de 5 euros', 'Trouve des pommes'],
